...
const serviceAccount = require('./cat-tinder-d3cc9-firebase-adminsdk-fbsvc-54a0e718c4.json'); // Make sure this file exists
...
let db;
try {
  const serviceAccount = require('./cat-tinder-d3cc9-firebase-adminsdk-fbsvc-54a0e718c4.json');
  
  admin.initializeApp({
    credential: admin.credential.cert(serviceAccount),
    databaseURL: 'https://cat-tinder-d3cc9.firebaseio.com'
  });
